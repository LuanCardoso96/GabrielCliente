  ...
  return (
    <Card className="group bg-gradient-to-br from-gray-900 to-black border-yellow-600/20 overflow-hidden hover:border-yellow-600/50 transition-all duration-300">
      <div className="relative h-64 overflow-hidden">
        <img
          src={product.imageUrl || "https://images.unsplash.com/photo-1541643600914-78b084683601?w=400"}
          alt={product.name}
      ...
      <CardContent className="p-4">
        ...
        <div className="space-y-2">
          ...
          <Link to={`/ProductDetails?id=${product.id}`} className="block">
            <Button
              variant="outline"
              disabled={product.stock === 0}
              className="w-full border-yellow-600 text-yellow-500 hover:bg-yellow-600 hover:text-black font-semibold"
            >
